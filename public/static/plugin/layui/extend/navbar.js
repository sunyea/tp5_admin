		...
		for(var i = 0; i < data.length; i++) {
			...
			if(data[i].children !== undefined && data[i].children.length > 0) {
				...
				if(data[i].icon !== undefined && data[i].icon !== '') {
					if(data[i].icon.indexOf('iconadmin-') !== -1) {
						ulHtml += '<i class="iconadmin ' + data[i].icon + '" aria-hidden="true" data-icon="' + data[i].icon + '"></i>';
					} else {
				...
				for(var j = 0; j < data[i].children.length; j++) {
					...
					if(data[i].children[j].icon !== undefined && data[i].children[j].icon !== '') {
						if(data[i].children[j].icon.indexOf('iconadmin-') !== -1) {
							ulHtml += '<i class="iconadmin ' + data[i].children[j].icon + '" data-icon="' + data[i].children[j].icon + '" aria-hidden="true"></i>';
						} else {
